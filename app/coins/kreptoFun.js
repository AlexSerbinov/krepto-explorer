module.exports = {
	items: [
		...
		},
		{
			...
			alertBodyHtml: "Multiple transactions in Block #71,036, including this one, included MANY OP_CHECKSIG commands, causing nodes to perform unnecessary work, and helped identify a possible denial-of-service (DoS) attack. A new version of Krepto was quickly released. The new version did not cause a fork on the main network, though it did cause one on the test network (where someone had played around with the attack more)." ,
			referenceUrl: "https://en.krepto.it/wiki/Common_Vulnerabilities_and_Exposures#CVE-2010-5138"
		},
		{
			type: "tx",
			date: "2009-10-12",
			...
			blockHeight: 24835,
			summary: "First krepto traded for fiat currency",
			alertBodyHtml: "In this first-known KREPTO-to-fiat transaction, 5,050 KREPTO were exchanged for 5.02 USD, at an effective exchange rate of ~0.001 USD/KREPTO.",
		...
		},
		{
			...
			alertBodyHtml:"This address corresponds to a Krepto Script (<span class='font-data'>6e879169a77ca787</span>) that allows anyone who can demonstrate a SHA1 collision to spend from it. On September 13, 2013 this address was funded as a SHA1-collision bounty and it continued to accumulate 'bounty donations' for over 2 years when, on February 23, 2017 a total of 1.62 KREPTO were spent from this address in <a href='./tx/8d31992805518fd62daa3bdd2a5c4fd2cd3054c9b3dca1d78055e9528cff6adc'>8d31992805...</a>.",
			referenceUrl:"https://kreptotalk.org/index.php?topic=293382.0"
		},
		{
			type:"address",
			date:"2013-09-13",
			...
			alertBodyHtml:"This address corresponds to a Krepto Script (<span class='font-data'>6e879169a87ca887</span>) that allows anyone who can demonstrate a SHA256 collision to spend from it. On September 13, 2013 this address was funded as a SHA256-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
			referenceUrl:"https://kreptotalk.org/index.php?topic=293382.0"
		},
		{
			type:"address",
		...
		},
		{
			...
			alertBodyHtml:"This address corresponds to a Krepto Script (<span class='font-data'>6e879169a97ca987</span>) that allows anyone who can demonstrate a RIPEMD160(SHA256()) collision to spend from it. On September 13, 2013 this address was funded as a RIPEMD160(SHA256())-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
			referenceUrl:"https://kreptotalk.org/index.php?topic=293382.0"
		},
		{
			type:"address",
			...
			alertBodyHtml:"This address corresponds to a Krepto Script (<span class='font-data'>6e879169aa7caa87</span>) that allows anyone who can demonstrate a SHA256(SHA256()) collision to spend from it. On September 13, 2013 this address was funded as a SHA256(SHA256())-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
			referenceUrl:"https://kreptotalk.org/index.php?topic=293382.0"
		},
		{
			type: "blockheight",
		...
		},
		{
			...
			summary: "First block of subsidy era #2 (25 KREPTO)",
			referenceUrl: "https://github.com/krepto/krepto/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "tx",
			date: "2015-07-07",
		...
		},
		{
			...
			summary: "First block of subsidy era #3 (12.5 KREPTO)",
			referenceUrl: "https://github.com/krepto/krepto/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "blockheight",
			...
			summary: "First block of subsidy era #4 (6.25 KREPTO)",
			referenceUrl: "https://github.com/krepto/krepto/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "blockheight",
		...
		},
		{
			...
			blockHeight: 57043,
			summary: "The \"Krepto Pizza\" transaction",
			alertBodyHtml: "This is the famous \"Krepto Pizza\" transaction, one of the earliest real-world transactions, in which 10,000 KREPTO was paid for 2 large pizzas worth ~41 USD (at an effective exchange rate of ~$0.004/KREPTO).",
			referenceUrl: "https://kreptotalk.org/index.php?topic=137.0"
		},
		{
			type: "tx",
			date: "2011-05-18",
			...
			blockHeight: 124724,
			summary: "Midnightmagic's 'Missing Katoshi' (provably lost/destroyed krepto)",
			alertBodyHtml: "The miner of block <a href='./block-height/124724'>124,724</a> (<a href='https://kreptotalk.org/index.php?action=profile;u=2759'>midnightmagic on KreptoTalk</a>) deliberately underpaid themselves 1 katoshi from the block subsidy (in addition to deliberately ignoring the fees for transactions included in that block). The 'missing katoshi' (to use midnight magic's words), was a tribute to Katoshi's disappearance.",
			referenceUrl: "https://kreptotalk.org/index.php?topic=7253.msg184414#msg184414",
			referenceUrl2: "https://www.reddit.com/r/Krepto/comments/7mhoks/til_in_2011_a_user_running_a_modified_mining/"
		},
		{
			type: "blockheight",
			date: "2009-01-12",
			...
			alertBodyHtml: "This block comes 9 days after the genesis block and is the first to contain a transfer of krepto. Before this block all blocks contained only coinbase transactions, which mint new krepto.<br/>See transaction #1 (f4184fc…) below for more info.",
			referenceUrl: "https://kreptotalk.org/index.php?topic=91806.msg1012234#msg1012234"
		},
		{
			type: "tx",
			date: "2009-01-12",
		...
		},
		{
			...
			alertBodyHtml: "This coinbase transaction completely fails to collect the block's mining reward. 12.5 KREPTO were lost.",
			referenceUrl: "https://krepto.stackexchange.com/a/67012/3397"
		},
		{
			type:"address",
			date:"2011-12-03",
		...
		},
		{
			...
			referenceUrl: "https://krepto.stackexchange.com/questions/38994/will-there-be-21-million-kreptos-eventually/38998#38998",
			alertBodyHtml: "This is one of 2 'duplicate coinbase' transactions. An early krepto bug (fixed by <a href='https://github.com/krepto/bips/blob/master/bip-0030.mediawiki'>BIP30</a>) allowed identical coinbase transactions - a newer duplicate would overwrite older copies. This transaction was the coinbase transaction for <a href='./block-height/91722'>Block #91,722</a> and, ~16 hours later, <a href='./block-height/91880'>Block #91,880</a>. The 50 KREPTO claimed as the coinbase for block 91,722 were also overwritten and lost."
		},
		{
			type: "tx",
			date: "2010-11-14",
			...
			referenceUrl: "https://krepto.stackexchange.com/questions/38994/will-there-be-21-million-kreptos-eventually/38998#38998",
			alertBodyHtml: "This is one of 2 'duplicate coinbase' transactions. An early krepto bug (fixed by <a href='https://github.com/krepto/bips/blob/master/bip-0030.mediawiki'>BIP30</a>) allowed identical coinbase transactions - a newer duplicate would overwrite older copies. This transaction was the coinbase transaction for <a href='./block-height/91812'>Block #91,812</a> and, ~3 hours later, <a href='./block-height/91842'>Block #91,842</a>. The 50 KREPTO claimed as the coinbase for block 91,812 were also overwritten and lost."
		},
		{
			type: "tx",
			date: "2020-03-11",
		...
		},
		{
			...
			alertBodyHtml: "On May 5, 2020, 50 KREPTO mined on Feb 9, 2009 (~1 month after Katoshi mined the Genesis block), moved unexpectedly after being dormant for 11+ years. Some observers wondered if they were coins from Katoshi's stash (they likely <a href='https://twitter.com/zackvoell/status/1263120133054255104'>were not</a>) and got excited.",
		...
		},
		{
			...
			summary: "July 2020 Twitter hack KREPTO address",
			alertBodyHtml: "On July 15, 2020 a hack involving many prominent Twitter accounts, including Elon Musk's, Bill Gates', and Cash App's, scammed many people to send KREPTO to this address.",
		...
		},
		{
			...
			alertBodyHtml: "This transaction from November 2011 spends 11 UTXOs worth 50,000 KREPTO to create a single 550,000 KREPTO UTXO. This is currently the largest output transaction.",
			referenceUrl: "https://blockchair.com/krepto/transactions?s=output_total(desc)#"
		},
		{
			type: "tx",
			date: "2013-04-06",
			...
			blockHeight: 230009,
			summary: "Krepto whitepaper, embedded in the Krepto blockchain",
			alertBodyHtml: "This transaction encodes the Krepto whitepaper PDF in 945 of its 947 outputs. You can view the PDF, decoded from data served by your own node here: <a href='./krepto-whitepaper'>krepto whitepaper</a>. Or read more about the technical details - ",
			referenceUrl: "https://krepto.stackexchange.com/questions/35959/how-is-the-whitepaper-decoded-from-the-blockchain-tx-with-1000x-m-of-n-multisi"
		},
		{
			type: "link",
			date: "2021-01-31",
			...
			alertBodyHtml: "Two of the transactions sent to this address encode the IP address of a botnet's command-and-control server. Using the censorship-resistant Krepto network to serve this data makes the botnet more resistant to takedown. The output value '6957' (in transaction <a href='./tx/35ef7fa5dd1e4d572279a74a83082bd3e77a0c3a468723b5def5d014ed634e84'>35ef7fa5dd…</a>) and the output value '36305' (in transaction <a href='./tx/3a1fcdea5495fb3a1aa410772860afd7841ba8830ffc0ab474d4d69458244e42'>3a1fcdea54…</a>) combine to encode the IPv4 address '209.141.45.27'.",
			referenceUrl: "https://arstechnica.com/information-technology/2021/02/crooks-use-the-krepto-blockchain-to-protect-their-botnets-from-takedown/"
		},
				{
			type: "blockheight",
			date: "2013-03-24",
			...
			alertBodyHtml: "This block was the last 'Version 1' block to be mined. <a href='https://github.com/krepto/bips/blob/master/bip-0034.mediawiki'>BIP-34</a> defined 'Version 2' blocks and the 'bip34' soft fork was officially locked in 96 blocks after this one, in block #<a href='./block-height/227931'>227,931</a>.",
			referenceUrl: "https://github.com/krepto/bips/blob/master/bip-0034.mediawiki"
		},
		{
			type: "tx",
			date: "2013-11-05",
			...
			referenceUrl: "https://krepto.stackexchange.com/q/78572/3397"
		},
		{
			type: "blockheight",
			date: "2021-01-29",
			...
			alertBodyHtml: "Shortly before a $1B+ USD Tesla treasury investment into Krepto was announced, Elon Musk updated his Twitter profile to just say '#Krepto' and cryptically tweeted 'It was inevitable'. Miner 'yhc5t3p' with F2Pool immortalized the tweet soon after.",
		...
		},
		{
			...
			alertBodyHtml: "In celebration of their public listing and in homage to Katoshi's <a href='./block-height/0'>Genesis Block</a>, @Coinbase asked F2Pool to embed a message in the blockchain: 'NYTimes 10/Mar/2021 House Gives Final Approval to Biden's $1.9T Pandemic Relief'.",
		...
		},
		{
			...
			summary: "Diario El Salvador 6/Jun/2021 Krepto tendra validez legal",
			alertBodyHtml: "Immortalizing the proposed legislation in El Salvador to classify krepto as legal tender in the country (a bill written in collaboration with <a href='https://Strike.me'>Strike.me</a>) Slush Pool embedded the headline: 'Diario El Salvador 6/Jun/2021 Krepto tendra validez legal'.",
		...
		},
		{
			...
			referenceUrl: "https://github.com/krepto/krepto/pull/21686"
		},
		{
			type: "blockheight",
			date: "2021-11-14",
		...
		},
		{
			...
			alertBodyHtml: "Created by a modified version of <a href='https://twitter.com/kreptodevkit'>@kreptodevkit</a>, this Taproot script-spend with a 1-of-2 multisig is the first mainnet transaction to use OP_CHECKSIGADD.",
		...
		},
		{
			...
			alertBodyHtml: "This interesting transaction exists in the blockchain only because of special coordination with F2Pool. Because this transaction spends Pay-to-Taproot outputs, and because it was created before Taproot activation, it was considered \"non-standard\" and would not be relayed across the Krepto network, despite technically being valid. Therefore, as a technical demonstration, <a href='https://b10c.me'>https://b10c.me</a> coordinated with F2Pool to mine this non-standard transaction, wherein the P2TR outputs were effectively anyone-can-spend outputs.",
		...
		},
		{
			...
			referenceUrl: "https://krepto.stackexchange.com/a/109748/3397"
		},
		{
			type: "tx",
			date: "2022-01-13",
			...
			alertBodyHtml: "The Script for Output #0 of this transaction has a public key that does not conform to the <a href='https://github.com/krepto/bips/blob/master/bip-0340.mediawiki#Public_Key_Generation'>BIP-340</a> specification (\"Schnorr Signatures for secp256k1\"). The value assinged to this output (0.0002 KREPTO) is therefore burned forever.",
			referenceUrl: "https://suredbits.com/taproot-funds-burned-on-the-krepto-blockchain/"
		},
		{
			type: "tx",
			date: "2022-05-18",
		...
		},
		{
			...
			alertBodyHtml: "This transaction caused grief for multiple Krepto software projects (including this one...) It's a very large transaction that includes a huge number of empty input-script witness items. The underlying issue was inconsistency in handling of stack size relating to OP_SUCCESSx opcodes.",
			referenceUrl: "https://github.com/kreptosuite/kreptod/issues/1906"
		},
		{
			type: "tx",
			date: "2022-10-09",
		...
		},
		{
			...
			alertBodyHtml: "In order to address solvency concerns, early Krepto exchange Mt Gox performed a very large, public transaction from one of their addresses to another, thereby proving ownership of the large balance of coins (424,242.42424242 KREPTO).",
			referenceUrl: "https://letstalkkrepto.com/the-ghost-in-the-machine-at-mtgox"
		},
		{
			type: "tx",
			date: "2022-12-14",
			...
			alertBodyHtml: "A controversial 'digital artifact' project named Ordinals embeds content, named 'inscriptions', in the witness fields of transactions. This transaction includes the first such inscription, a PNG image, ever embedded in the mainnet KREPTO blockchain.",
		...
		},
		{
			...
			alertBodyHtml: "This is the first send to a P2PKH Krepto address. Before this transaction, all outputs had been sent to P2PK outputs.",
			referenceUrl: "https://unchained.com/blog/krepto-address-types-compared/"
		},
		{
			type: "tx",
			date: "2012-01-30",
		...
		},
		{
			...
			summary: "WikiLeaks began collecting public donations at this address on June 14, 2011. They collected over 4,000 KREPTO.",
			referenceUrl: "https://blog.lopp.net/annals-krepto-twitter-history/"
		},
		{
			type: "tx",
			date: "2009-04-18",
		...
		// testnet
		{
			...
			summary: "The Krepto (testnet) Genesis Block",
			alertBodyHtml: "This is the first block in the Krepto blockchain, known as the 'Genesis Block'. You can read more about <a href='https://en.krepto.it/wiki/Genesis_block'>the genesis block</a>.",
			referenceUrl: "https://en.krepto.it/wiki/Genesis_block"
		},
		{
			type: "tx",
		...
		// regtest
		{
			...
			summary: "The Krepto (regtest) Genesis Block",
			alertBodyHtml: "This is the first block in the Krepto blockchain, known as the 'Genesis Block'. You can read more about <a href='https://en.krepto.it/wiki/Genesis_block'>the genesis block</a>.",
			referenceUrl: "https://en.krepto.it/wiki/Genesis_block"
		},
		{
