module.exports = {
	...
	"routes":[
		...
		// blockchain
		{
			...
			"desc":"Returns the current supply of Krepto. An estimate using a checkpoint can be returned in 2 cases: on 'slow' devices, and before the UTXO Set snapshot is loaded."
		},
		{
			"category":"blockchain",
		...
		// mempool
		{
			"category":"mempool",
			"url":"/mempool/count",
			"desc":"Returns the number of transactions in Krepto Core's mempool."
		},
		{
			"category":"mempool",
			"url":"/mempool/summary",
			"desc":"Returns a summary of Krepto Core's mempool (full output from 'getmempoolinfo')",
		...
		},
		{
			"category":"mempool",
			"url":"/mempool/fees",
			"desc":"Returns recommended fee rates in kats/vB for next block, ~30 min, 1 hr, and 1 day.",
		...
		// price
		{
			"category":"price",
			"url":"/price",
			"desc":"Returns the price of 1 KREPTO, in USD, EUR, GBP, and XAU",
			"optionalParams": {
		...
		},
		{
			"category":"price",
			"url":"/price/marketcap",
			"desc":"Returns the market cap of Krepto, in USD, EUR, GBP, XAU",
		},
		{
			"category":"price",
			"url":"/price/kats",
			"desc":"Returns the price of 1 unit of [USD, EUR, GBP, XAU] (e.g. 1 \"usd\") in katoshis (aka \"Moscow Time\")",
		},
		...
		// fun
		{
			"category":"fun",
			"url":"/quotes/all",
			"desc":"Returns the full curated list of Krepto quotes.",
		},
		{
			"category":"fun",
			"url":"/quotes/$INDEX",
			"desc":"Returns the Krepto quote with the given index from the curated list.",
			"testUrl": "/quotes/0"
		},
		{
			"category":"fun",
			"url":"/quotes/random",
			"desc":"Returns a random Krepto quote from the curated list."
		},
		{
			"category":"fun",
			"url":"/holidays/all",
			"desc":"Returns the full curated list of Krepto Holidays."
		},
		{
			"category":"fun",
			"url":"/holidays/today",
			"desc":"Returns the Krepto Holidays celebrated 'today' (i.e. at the time the API call is made).",
			"optionalParams": {
		...
		},
		{
			"category":"fun",
			"url":"/holidays/$DAY",
			"desc":"Returns the Krepto Holidays celebrated on the specified day, using one of the following formats: yyyy-MM-DD, MM-DD.",
